 ...
 */
public class PlayingPage1 extends AppCompatActivity implements MediaPlayer.OnCompletionListener{
        ...
        query.getFirstInBackground(new GetCallback<ParseObject>() {
            ...
            public void done(ParseObject parseObject, ParseException e) {
                if (parseObject != null) {
                    ...
                    Toast.makeText(PlayingPage1.this, "Data load fail", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public void PlayMedia(String audioFile){
        ...
        try {
            ...
            final ProgressDialog dialog = new ProgressDialog(PlayingPage1.this);
...
// check for already playing
    ...
    public void next(View view){
        ...
        try {
            list = query.find();
            String nextStory = list.get(currentSongIndex+1).getParseFile("Source").getUrl();
            PlayMedia(nextStory);
